...
python main.py --game amidar
python main.py --game assault
python main.py --game asterix
python main.py --game bank_heist
python main.py --game battle_zone
python main.py --game boxing
...
python main.py --game jamesbond
python main.py --game kangaroo
python main.py --game krull
